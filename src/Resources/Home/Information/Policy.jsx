          ...
          <div className={cx("content")}>
            ...
            <div className="des-con">
              ...
              <p>
                ...
                http://localhost:5173, chúng tôi thu thập:
              </p>
              ...
              <ul ms-role="list">
                ...
                {/* <li ms-role="item">
                  <p>
                    ...
                    đã đăng nhập vào http://localhost:5173 bằng cách sử dụng chi
              ...
              <p>
                ...
                chức năng xem Thông tin cá nhân trong tài khoản báo trí Cần
                Thơ của mình.
              </p>
              ...
              <ul ms-role="list">
                <li ms-role="item">
                  Đăng ký tài khoản trên http://localhost:5173
                </li>
                <li ms-role="item">
